...
class MemberRenewalReminder2Notification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    {
        $template = NotificationTemplate::findByIdentifier('member_renewal_reminder_2');
