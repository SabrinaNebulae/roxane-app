...
class MemberRenewalReminder3Notification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    {
        $template = NotificationTemplate::findByIdentifier('member_renewal_reminder_3');
